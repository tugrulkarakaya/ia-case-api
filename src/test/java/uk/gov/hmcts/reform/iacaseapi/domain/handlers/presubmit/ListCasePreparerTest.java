...
public class ListCasePreparerTest {
    ...
    @Test
    public void should_clear_previous_list_case_hearing_fields_for_reheard_appeal() {
    ...
    @Test
    public void should_not_clear_previous_list_case_hearing_fields_when_feature_flag_disabled() {
    ...
    @Test
    public void should_not_clear_previous_list_case_hearing_fields_for_normal_appeal() {
